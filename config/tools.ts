...
export const TOOLS: ToolDefinition[] = [
  // --- YOUTUBE TOOLS ---
  {
    ...
    description: 'Generate full-length, high-retention video scripts with hooks, body, and CTA.',
    category: 'youtube',
    icon: 'FileText',
    cost: 5,
    inputs: [
      { name: 'topic', label: 'Video Topic', type: 'text', placeholder: 'e.g., The Future of AI in 2025', required: true },
      { name: 'audience', label: 'Target Audience', type: 'text', placeholder: 'e.g., Tech Enthusiasts', required: true },
      { name: 'tone', label: 'Script Tone', type: 'select', options: ['Professional', 'Engaging', 'Humorous', 'Urgent', 'Storytelling'], required: true },
      { name: 'length', label: 'Video Length', type: 'select', options: ['Short (60s)', 'Medium (5-8 min)', 'Long (10+ min)'], required: true },
      { name: 'language', label: 'Language', type: 'select', options: ['English', 'Spanish', 'French', 'German', 'Hindi'], required: true }
    ],
